...
let {pasen, kerstmis, pinksteren, nieuwjaar, hemelvaart, koningsdag } = bereken_feestdagen();

export const feestdagen = {pasen, kerstmis, pinksteren, nieuwjaar, hemelvaart, koningsdag };
