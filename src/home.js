        ...
        <div className="content-home">
          ...
          <div className="tekst">
            <p>
              ...
              mobiliteit.<br />
              <br />
              De 60+ bus rijdt u in de stad Schagen van uw{" "}
              <strong>eigen</strong> huis naar een door u gewenste locatie.<br />
              <br />
              De bus wordt gereden door vrijwilligers en u kunt eenvoudig
              telefonisch een rit (zowel heen als terug) reserveren.<br />
              <br />
              Een rit kost slecht € 1,00 per enkele reis.<br />
              <br />
